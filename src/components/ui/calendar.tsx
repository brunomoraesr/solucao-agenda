  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // AJUSTE: Removido o "[&:has([aria-selected])]:bg-accent" daqui
        ...
        // AJUSTE: Aplicado o contorno (border) e fundo transparente aqui
        day_selected:
          "bg-transparent text-primary border border-primary hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary",
